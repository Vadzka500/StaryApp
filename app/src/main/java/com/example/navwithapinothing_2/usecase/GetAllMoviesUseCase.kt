 ...
 * @Date: 21.05.2025
 */
class GetAllMoviesUseCase @Inject constructor(private val repository: MovieDatabaseRepository) {
    operator fun invoke(): Flow<ResultDb<List<MovieDb>>> = repository.getAllMovies()
}