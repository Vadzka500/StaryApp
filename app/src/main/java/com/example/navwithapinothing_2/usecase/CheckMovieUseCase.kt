 ...
 * @Date: 21.05.2025
 */
class CheckMovieUseCase @Inject constructor(private val movieDatabaseRepository: MovieDatabaseRepository) {

    operator fun invoke(id: Long): Flow<ResultDb<MovieDb?>> = movieDatabaseRepository.checkMovie(id)
}